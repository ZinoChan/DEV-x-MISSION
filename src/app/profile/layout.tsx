          ...
          {status === 'authenticated' && (
            <div className='flex items-center space-x-2'>
              ...
              <div className='text-center'>
                ...
                <button className='rounded-full border border-gray-4 px-3 py-1.5 text-sm font-medium capitalize text-gray-4 transition-all hover:bg-gray-4 hover:text-white'>
                  edit profile
                </button>
              </div>
            </div>
